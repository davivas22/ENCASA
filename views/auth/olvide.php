  ...
  .login__instruction {
    ...
    >
      ...
      <g mask="url(#mask0)" transform="scale(1.4)">
        ...
        <image
          class="login__img"
          href="imagenes/Beige Brown Minimal Modern Aesthetic Fashion Clothes Brand Sales Collage Presentation.svg"
        />
      </g>
    </svg>
    ...
    <div class="login container grid" id="loginAccessRegister">
      ...
      <div class="login__access">
        <h1 class="login__title">¿Has olvidado tu contraseña?</h1>
            ...
            <div class="login__content grid">
              <div class="login__box">
                <input
                  ...
                  class="login__input"
                />
                <label for="email" class="login__label">Correo electronico de recuperación</label>

              </div>
              
          

            <a href="index.html" class="login__button">Enviar enlace de recuperación</a>
          </form>

          <p class="login__switch">
             No tienes una cuenta?
             <a href="/crearcuenta">Registrate</a>
          </p>
        </div>
      </div>